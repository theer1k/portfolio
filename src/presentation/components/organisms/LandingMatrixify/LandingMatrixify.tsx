...
export const LandingMatrixify = () => {
  ...
  const messages = ['Wake up...', 'Wake up...', 'The Matrix has you.'];
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="absolute z-20 flex h-20 min-w-20 items-center justify-center px-6 py-4 text-center text-xl font-bold text-green-500 hover:text-green-600"
      ></div>
    </div>
  );
};
